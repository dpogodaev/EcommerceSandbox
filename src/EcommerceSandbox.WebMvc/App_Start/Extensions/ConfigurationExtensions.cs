...
namespace EcommerceSandbox.WebMvc.Extensions;
...
public static class ConfigurationExtensions
{
    ...
    public static bool IsSectionExists(this IConfiguration configuration, string key)
    {
    ...
    /// <param name="configuration">Represents a set of key/value application configuration properties.</param>
    /// <param name="key">The key of the configuration section. The colon is used as a separator.</param>
    /// <returns><c>true</c> if the section with the specified key is not found; <c>false</c> otherwise.</returns>
    public static bool IsSectionNotExists(this IConfiguration configuration, string key)
    {
        return !configuration.IsSectionExists(key);
    }
    ...
    /// <c>false</c> otherwise.
    /// </returns>
    public static bool IsPropertyExists(this IConfiguration configuration, string key)
    {
    ...
    /// <c>false</c> otherwise.
    /// </returns>
    public static bool IsPropertyNotExists(this IConfiguration configuration, string key)
    {
        return !configuration.IsPropertyExists(key);
    }
